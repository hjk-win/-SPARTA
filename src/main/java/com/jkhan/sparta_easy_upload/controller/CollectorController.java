...
public class CollectorController {
    ...
    public ResponseEntity<Integer> addCollector(CollectorInfo collector) throws BusinessException {
        return new ResponseEntity<>(ResponseEnum.SUCCESS, collectorService.insertCollector(collector));
    }
    ...
    public ResponseEntity<Integer> addCollectors(List<CollectorInfo> collectorInfoList) throws BusinessException {
        return new ResponseEntity<>(ResponseEnum.SUCCESS, collectorService.insertCollectorList(collectorInfoList));
    }
    ...
    public ResponseEntity<Integer> deleteCollector(@PathVariable("collectorId") Integer collectorId) throws BusinessException {
        return new ResponseEntity<>(ResponseEnum.SUCCESS, collectorService.deleteCollectorById(collectorId));
    }
    ...
    public ResponseEntity<Integer> updateCollectorInfo(@PathVariable("collectorId") Integer collectorId, CollectorInfo collectorInfo) throws BusinessException {
        return new ResponseEntity<>(ResponseEnum.SUCCESS, collectorService.updateCollectorInfo(collectorInfo));
    }
    ...
    public ResponseEntity<CollectorInfo> getCollector(@PathVariable("collectorId") Integer collectorId) throws BusinessException {
        return new ResponseEntity<>(ResponseEnum.SUCCESS, collectorService.selectCollectorById(collectorId));
    }

    @GetMapping("/collectors")
    public ResponseEntity<List<CollectorInfo>> getCollectors() {
        return new ResponseEntity<>(ResponseEnum.SUCCESS, collectorService.selectCollectors());
    }
    ...
    public ResponseEntity<CollectorInfo> getMyPresenters(@PathVariable("collectorId") Integer collectorId) {
        return new ResponseEntity<>(ResponseEnum.SUCCESS, collectorService.selectMyPresenters(collectorId));
    }
    ...
    public ResponseEntity<CollectorInfo> getPublishedTasks(@PathVariable("collectorId") Integer collectorId) {
        return new ResponseEntity<>(ResponseEnum.SUCCESS, collectorService.selectPublishedTasks(collectorId));
    }
}
